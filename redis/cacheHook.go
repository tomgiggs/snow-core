...
func (h *SkywalkingHook) BeforeProcess(ctx context.Context, cmd goredis.Cmder) (context.Context, error) {
	...
	span, err := h.tracer.CreateExitSpan(ctx, fmt.Sprintf("%v %v", cmd.Name(), args), peer, func(header string,val string) error {
		return nil
	})
	if err != nil {
		return nil, err
...
func (h *SkywalkingHook) BeforeProcessPipeline(ctx context.Context, cmds []goredis.Cmder) (context.Context, error) {
	...
	span, err := h.tracer.CreateExitSpan(ctx, pipelineInfo, peer, func(header string,val string) error {
		return nil
	})
	if err != nil {
		return nil, err
